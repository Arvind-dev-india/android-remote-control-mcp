...
object OptionalToolPermissions {
    ...
    /**
     * Effective config for registration: the stored allowlist minus tools whose optional
     * permission is not in [granted], plus disabled parameters. [stored] is not mutated.
     */
    fun effectivePermissions(
        ...
        return stored.copy(
            enabledTools = stored.enabledTools - toolsMissingPermission(granted),
